...
function ProductCard({ product, onAddToCart, linkToDetail = false }) {
  ...
  return (
    <article className="card-hover-glow relative flex h-[420px] w-full flex-col rounded-lg border border-slate-100 bg-white p-4 shadow-sm">
      ...
      <button
        ...
        className="btn-interactive mt-auto w-full rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:transform-none"
