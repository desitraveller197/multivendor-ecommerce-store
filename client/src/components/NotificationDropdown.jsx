...
function NotificationDropdown({ notifications = [] }) {
  ...
  return (
    <div className="relative">
      ...
      {open ? (
        <div className="animate-scale-up-fade origin-top-right absolute right-0 z-20 mt-2 w-[min(20rem,calc(100vw-2rem))] rounded-xl border border-slate-200 bg-white p-3 shadow-lg">
