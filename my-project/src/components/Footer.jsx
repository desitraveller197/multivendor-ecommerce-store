...
const PAYMENT_METHODS = [
  { name: 'Easypaisa', logo: '/images/payments/easypaisa.svg', description: 'Card & wallet payments' },
          ...
          {loading ? (
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {displayReviews.map((review) => (
                <article
                  key={review.id}
                  className="rounded-xl border border-slate-100 bg-slate-50/80 p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md"
                >
                    ...
                    <div className="min-w-0 flex-1">
                      {review.productId ? (
                        <Link
                          ...
                          className="line-clamp-1 text-sm font-semibold text-blue-700 hover:text-blue-900"
                        >
        ...
        <div className="grid gap-8 border-t border-slate-200 pt-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-600">
              ...
              <li>
                <Link to="/regional" className="hover:text-blue-700">
                  Regional Collections
                </Link>
              </li>
              <li>
                <Link to="/shops" className="hover:text-blue-700">
                  Seller Shops
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-600">
              <li>Email: support@bazarix.pk</li>
